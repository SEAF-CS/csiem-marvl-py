...
`csiem-marvl-py` is a Python package for post-processing and visualising outputs from the Cockburn Sound Integrated Ecosystem Model (CSIEM).
...
```
pip install git+https://github.com/SEAF-CS/csiem-marvl-py
```
